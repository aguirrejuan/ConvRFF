...
def get_model(input_shape=(128,128,3), name='FCN', out_channels=1, out_ActFunction='sigmoid'):
    ...
    level_1 = DefaultConv2D(64,kernel_initializer=kernel_initializer(343),name='Conv01')(level_1)
    ...
    level_2 = DefaultConv2D(128,kernel_initializer=kernel_initializer(343),name='Conv02')(level_2)
